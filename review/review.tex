...
\href{https://www.phei.com.cn/module/goods/wssd_content.jsp?bookid=52723}{电子工业出版社官网},\href{http://product.dangdang.com/25338942.html}{当当},\href{https://detail.tmall.com/item.htm?spm=a1z10.5-b.w4011-17538325040.26.129d66dbA1Cn8D&id=576915359900&rn=de470f45922c94391043e09f1304e7e9&abbucket=3} {天猫旗舰店},\href{https://item.jd.com/12424029.html?dist=jd}{京东},亚马逊
	\end{block}
\begin{block}{讲义和代码}
...
const int *ptrc = &ci; //=左边部分从右向左阅读（p.57），ptrc 指向常量ci
        \end{lstlisting}
		\end{itemize}
	\end{block}
...
int &r4 = 100, &r5 = i+1, &r6 = ci; //错误：只能引用非 const 左值（p.19）
            \end{lstlisting}
	\end{block}
\end{frame}
